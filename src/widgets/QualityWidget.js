...
import { ColumnMediumGappedList, LinearGappedList, RowTinyGappedList } from "../components/common/LinearGappedList";
import { OpinionPane } from "./opinions/OpinionPane";
...
export const QualityWidget = () => {
    ...
    //             return <NewOpinionComponent key={index} opinionDTO={filteredOpinion} />
